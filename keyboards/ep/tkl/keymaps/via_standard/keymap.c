...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT( \
        KC_ESC, KC_ESC,             KC_F1,    KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,   KC_F10,   KC_F11,   KC_F12,       KC_PSCR,  LT(1, KC_SLCK),  MT(MOD_LCTL, KC_PAUSE),\
               ...
               KC_LSFT,  KC_NUBS,  KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM, KC_SLASH,   KC_A,  KC_RSFT,                          KC_UP,        \
               KC_LCTL,  KC_LGUI,  KC_LALT,                        KC_SPC,                          KC_RALT,  KC_RGUI,  KC_SLSH,   KC_SLSH,      KC_LEFT,  KC_DOWN,  KC_RGHT \
 ),
 [_FN1] = LAYOUT( \
